...
import { IconAccessibleForward } from "../../icons/IconAccessibleForward";
...
export const ConcreteComponentNode = ({ icon }) => {
  return (
    <>
      ...
      {icon === "accessible-forward" && <IconAccessibleForward className="concrete-component-node" />}
      ...
      {icon === "arrow-back" && <IconArrowBack className="concrete-component-node" />}

      {icon === "arrow-downward" && <IconArrowDownward className="concrete-component-node" />}

      {icon === "arrow-drop-down" && <IconArrowDropDown className="concrete-component-node" />}

      {icon === "arrow-drop-up" && <IconArrowDropUp className="concrete-component-node" />}

      {icon === "arrow-forward" && <IconArrowForward className="concrete-component-node" color="black" />}

      {icon === "arrow-upward" && <IconArrowUpward className="concrete-component-node" />}

      {icon === "assessment" && <Icon8 className="concrete-component-node" color="black" />}
      ...
      {icon === "drag-handle" && <IconDragHandle className="concrete-component-node" />}

      {icon === "eco" && <IconEco className="concrete-component-node" />}
      ...
      {icon === "expand-less" && <Icon63 className="concrete-component-node" color="black" />}

      {icon === "expand-more" && <Icon73 className="concrete-component-node" color="black" />}

      {icon === "facebook" && <Icon25 className="concrete-component-node" />}
      ...
      {icon === "info" && <IconInfo className="concrete-component-node" />}

      {icon === "insights" && <IconInsights className="concrete-component-node" />}

      {icon === "linegraph" && <IconLinegraph className="concrete-component-node" />}
      ...
      {icon === "map" && <IconMap className="concrete-component-node" />}
      ...
      {icon === "military-tech" && <IconMilitaryTech1 className="concrete-component-node" />}
      ...
      {icon === "navigate-next" && <Icon33 className="concrete-component-node" />}
      ...
      {icon === "popout" && <IconPopout className="concrete-component-node" />}

      {icon === "print" && <IconPrint className="concrete-component-node" />}
      ...
      {icon === "push-pin" && <IconPushPin className="concrete-component-node" />}
      ...
      {icon === "rss-feed" && <Icon32 className="concrete-component-node" />}
      ...
      {icon === "save-alt" && <IconSaveAlt className="concrete-component-node" />}
      ...
      {icon === "science" && <IconScience className="concrete-component-node" />}

      {icon === "search" && <Icon74 className="concrete-component-node" color="black" />}
      ...
      {icon === "share" && <IconShare className="concrete-component-node" />}
      ...
      {icon === "visibility-off" && <IconVisibilityOff1 className="concrete-component-node" />}
      ...
      {icon === "tools" && <Icon9 className="concrete-component-node" color="#1B1B1B" />}
    </>
  );
};
